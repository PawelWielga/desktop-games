...
const technicalDetailsStyle: React.CSSProperties = {
  width: "100%",
  maxWidth: "52rem",
};
...
> {
  ...
  render(): React.ReactNode {
    ...
    return (
      <div className="window-error-boundary" role="alert" aria-live="assertive" style={errorBoundaryStyle}>
        ...
        {showDetails && (
          <details className="window-error-boundary__details" style={technicalDetailsStyle}>
            ...
            <dl>
              ...
              {stackTrace && (
                <>
                  ...
                  <dd>
                    <pre style={preStyle}>{stackTrace}</pre>
                  </dd>
                </>
              )}
              {componentStack && (
